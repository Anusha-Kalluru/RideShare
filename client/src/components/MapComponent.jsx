...
import { MapContainer, TileLayer, Marker, Popup, useMap, Polyline } from 'react-leaflet'; // For map UI
import L from 'leaflet'; // Core map engine
...
const geocodeCache = {}; // Converts: "New York" --> [lat, lon] 
