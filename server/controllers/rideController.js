...
exports.createRide = async (req, res, next) => {
    try {
        const { departure, destination, date, time, price, availableSeats } = req.body; //extract data from frontend
        ...
        const ride = await Ride.create({ //Database Save
            //driver identification
            driverId: req.user._id, // Comes from JWT middleware (protect)
            departure,
            destination,
            date,
            time,
